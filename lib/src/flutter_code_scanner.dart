...
typedef QRViewCreatedCallback = void Function(QrController);
typedef PermissionSetCallback = void Function(QrController, bool);
...
class _QRViewState extends State<QRView> {
  ...
  Future<void> updateDimensions() async {
    await QrController.updateDimensions(
  ...
  void _onPlatformViewCreated(int id) {
    ...
    final controller = QrController._(
        _channel,
...
class QrController {
  QrController._(MethodChannel channel, GlobalKey? qrKey,
  ...
  Future<void> _startScan(GlobalKey key, QrScannerOverlayShape? overlay,
    ...
    try {
      await QrController.updateDimensions(key, _channel, overlay: overlay);
